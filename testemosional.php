...
<head>
  <title>Test Kecerdasan Emosional</title>
  <!-- Required meta tags -->
  <meta charset="utf-8">
...
<div class="container-fluid position-relative p-0">
    ...
    <div class="dropdown-menu">
        ...
        <div class="containerxxl bg-info hero-header">
                <div class="container">
                    <div class="row g-5 align-items-center">
                        <div class="text-center">
                            <h1 class="text-white mb-4 animated zoomIn">Test Kecerdasan Emosional</h1>
  ...
  <div class="container">
    <div class="row justify-content-center wow fadeInUp" data-wow-delay="0.1s">
      <div class="col-md-7 order-md-2">
        <div class="d-inline-block border rounded-pill text-info px-4 mb-3">Testimonial</div>
        <h2 class="mb-5">Tes Tingkat Keparahan Emosi: Mengenal Diri Lebih Dalam</h2>
        <p>Tes ini bertujuan untuk mengenali diri sendiri lebih dalam apakah kita memiliki sifat yang beda dari orang lain atau memiliki sifat yang sama dengan orang lain.</p>
        <div class=" mb-5">
        <a href="mulaites.php" class="btn btn-outline-purple rounded-pill border-2 py-3 px-5 animated slideInRight"style="background-color: #3104c6e2;">Tes Emosionalmu</a>


        </div>
      </div>
      <div class="col-md-5 order-md-1">
        <img src="img/gila.jpg" alt="Testimonial Image" class="img-fluid rounded mx-auto d-block">
      </div>
    </div>
  </div>
</div>        
